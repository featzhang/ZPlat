 ...
 * @version 1.2
 */
public class ZMonthChooser extends JPanel implements ItemListener, ChangeListener {
	...
	private ZDayChooser dayChooser;
	private ZYearChooser yearChooser;
	 ...
	 */
	public ZMonthChooser(boolean hasSpinner) {
		super();
	 ...
	 *            the day chooser
	 */
	public void setDayChooser(ZDayChooser dayChooser) {
	 ...
	 */
	public void setYearChooser(ZYearChooser yearChooser) {
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new ZMonthChooser());
		frame.pack();
