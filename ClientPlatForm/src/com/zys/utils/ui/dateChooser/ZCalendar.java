...
public class ZCalendar extends JPanel implements PropertyChangeListener {
	private Calendar calendar;

	/** the day chooser */
	protected ZDayChooser dayChooser;
	...
	/** the month chooser */
	protected ZMonthChooser monthChooser;
	private JPanel monthYearPanel;

	/** the year chhoser */
	protected ZYearChooser yearChooser;
	 ...
	 */
	public ZCalendar(boolean monthSpinner) {
	 ...
	 *            the new locale
	 */
	public ZCalendar(Locale locale) {
	 ...
	 *            the new locale
	 */
	public ZCalendar(Date date, Locale locale) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public ZCalendar(Date date, boolean monthSpinner) {
	 ...
	 *            false, if no month spinner should be used
	 */
	public ZCalendar(Locale locale, boolean monthSpinner) {
	 ...
	 */
	public ZCalendar(Date date, Locale locale, boolean monthSpinner,
		...
		monthChooser = new ZMonthChooser(monthSpinner);
		yearChooser = new ZYearChooser();
		...
		dayChooser = new ZDayChooser(weekOfYearVisible);
	 ...
	 */
	public ZDayChooser getDayChooser() {
		return dayChooser;
	}
	 ...
	 */
	public ZMonthChooser getMonthChooser() {
		return monthChooser;
	}
	 ...
	 */
	public ZYearChooser getYearChooser() {
		return yearChooser;
	}
