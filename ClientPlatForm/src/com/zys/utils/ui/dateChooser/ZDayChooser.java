 ...
 * @version 1.2.1
 */
public class ZDayChooser extends JPanel implements ActionListener, KeyListener,
		FocusListener {
	class WeekButton extends JButton {

		private static final long serialVersionUID = -3543698560187206185L;
...
//			this.setBorder(null);
	 ...
	 */
	public ZDayChooser(boolean weekOfYearVisible) {
		...
		weeks = new WeekButton[7];

		for (int i = 0; i < 7; i++) {
			weeks[i] = new WeekButton() {
				public void addMouseListener(MouseListener l) {
				}
	...
	public static void main(String[] s) {
		...
		frame.getContentPane().add(new ZDayChooser());
		frame.pack();
