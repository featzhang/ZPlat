package cn.zhangzuofeng.idtv.ui.resource;
...
public class ZResourceUtils {
    ...
    static {
        try {
            resources = ResourceBundle.getBundle("cn.zhangzuofeng.idtv.ui.resource.client",
                    Locale.getDefault());
        } catch (MissingResourceException mre) {
            System.err.println("cn/zhangzuofeng/AddressList.properties not found");
            System.exit(1);
        }
    }
    ...
    private static String getImageDir() {
        String string = getString("images.dir");
        return string;
    }
